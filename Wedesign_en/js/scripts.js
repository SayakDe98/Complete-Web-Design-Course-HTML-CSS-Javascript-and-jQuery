...
var currentService = 0 /* let's define currentService as 0 since array value starts from 0 and when we click on prev arrow then we will decrement this value and when we click on next arrow then we will increment this value*/
